...
1. Always read the relevant file in `3DVSubmission/sec.back/` before making edits to the active `sec/` files.
2. Preserve template commands (e.g., `\confName`, `\maketitle`, bibliography style) unless explicitly instructed.
3. Do not remove or alter the conference template files (e.g., `cvpr.sty`, `preamble.tex`) unless user asks.

See `Scratch.md` for project-specific notes used to draft the paper.
